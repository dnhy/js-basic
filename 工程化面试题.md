...
![image-20241020165546590](/Users/dnhy/Library/Application Support/typora-user-images/image-20241020165546590.png)
...
![image-20241020173731438](/Users/dnhy/Library/Application Support/typora-user-images/image-20241020173731438.png)
...
可以使用import.meta对象访问.env配置文件中的变量

webpack需安装dotenv，项目根目录下创建.env.test文件，加载配置文件：
...
vite自带dotenv，创建.env.test配置文件，加载配置文件：
...
vue-cli自带dotenv，创建.env.test配置文件，加载配置文件：
